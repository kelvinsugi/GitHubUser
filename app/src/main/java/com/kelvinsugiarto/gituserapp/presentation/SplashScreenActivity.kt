...
import com.kelvinsugiarto.gituserapp.databinding.ActivitySplashScreenBinding
...
class SplashScreenActivity : AppCompatActivity() {
    ...
    private val activityHandler = Handler(Looper.myLooper()!!)
    ...
    private fun navigateToMainActivity(){
            ...
            val expired = dataLogin[Constants.SHARED_PREF_KEY_LOGIN_EXPIRED_STRING, "0"]

            if (token.isNotEmpty()){
                val currentTime = System.currentTimeMillis()/1000
                if(expired.toLong() > 0 && currentTime <= expired.toLong()){
                    finish()
